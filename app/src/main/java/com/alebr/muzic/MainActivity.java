...
public class MainActivity extends AppCompatActivity implements MediaBrowserProvider, ListFragment.FragmentListListener, QueueFragment.QueueFragmentListener {
    ...
    private ListFragment albumFragment = ListFragment.newInstance(MusicLibrary.ALBUMS);
    private ListFragment artistFragment = ListFragment.newInstance(MusicLibrary.ARTISTS);
    private ListFragment songsFragment = ListFragment.newInstance(MusicLibrary.SONGS);
